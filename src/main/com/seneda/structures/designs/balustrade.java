...
//
//        Lamination l = Lamination.findSufficientLamination(min_thick_defl_line, min_thick_str_line, height, interlayerShearModulus, loadCase);
//
...
//
//        double actual_deflection = LineLoad.deflectionFromThickness(line_load, Properties.YoungsModulus, effective_thickness_for_deflection, height);
//
